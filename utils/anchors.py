...
def gen_anchor_targets(
    ...
    for index, (image, bboxes, labels) in enumerate(zip(image_batch, bboxes_batch, labels_batch)):
        if bboxes.shape[0]:
            ...
            labels_batch[index, positive_indices, labels
